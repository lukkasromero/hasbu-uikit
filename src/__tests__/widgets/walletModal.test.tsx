    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          >
            <h2
              class="sc-bdfBwQ sc-hKgILt ljmuNB ESJmc"
              color="text"
            >
              Connect to a wallet
            </h2>
          ...
          <button
            ...
            class="sc-jSgupP fjvtIE sc-gKsewC kpTpvg"
            type="button"
          >
            <svg
              class="sc-dlfnbm kbqCub"
              color="primary"
              viewBox="0 0 24 24"
              width="20px"
        ...
        >
          <button
            class="sc-jSgupP isrZmF"
            id="wallet-connect-metamask"
            style="justify-content: space-between;"
            type="button"
          >
            <div
              class="sc-bdfBwQ jiFgIL"
              color="primary"
            >
              Metamask
            </div>
            <svg
              class="sc-dlfnbm fDvPVQ"
              color="text"
              viewBox="0 0 96 96"
              width="32px"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            class="sc-bdfBwQ sc-gsTCUz hlcAOW djpNeP sc-iqHYGH hzLTbV"
            color="primary"
    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          >
            <a
              class="sc-bdfBwQ sc-gsTCUz BkBNt djpNeP"
              color="primary"
            ...
            <div
              class="sc-bdfBwQ sc-crrsfI kbzYn coLARd"
              color="text"
              role="button"
            >
              Copy Address
